...
* **base/** intended as a folder to house the baseline styles. Will include mixins and baseline variables (colors, breakpoints, etc).
* **components/** these module files are the reusable or component parts of our design.
* **components/atoms/** these are granular module files that cannot be broken down into smaller components (eg. a, blockquote, list, typography).
